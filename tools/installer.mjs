...
export function catalog(ROOT, gpu) {
  ...
  const items = [
    ...
    },
    {
      ...
      enables: "the Convert tab's quality enhance tier",
      why: "sharper grain and hair detail than the Compact net, at ~18× the time per frame",
      sizeMB: 64,
    ...
    },
    {
      id: "esrgan-general",
      group: "Texture enhance",
      label: "Real-ESRGAN Compact x4v3",
      enables: "the Convert tab's default enhance tier",
      why: "measured 674 ms per 2048² atlas on an RTX 2080 Ti against 12.3 s for x4plus: 18× faster for a slight softening, and 4.7 MB on disk",
      sizeMB: 5,
      vramMB: 700,           // measured at tile 1024; 0.1 GB at tile 256
      optional: false,
      requires: ["python-env"],
    ...
    },
    {
      ...
      enables: "the Convert tab's portable enhance tier",
      why: "standalone Vulkan binary, no Python environment, and it runs on AMD and Intel GPUs",
      sizeMB: 43,

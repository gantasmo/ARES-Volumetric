...
- **Windows, 1-click:** **`ARES.vbs bench`** (repo root; `ARES-console.cmd bench` to watch it). Runs silently (~1–2 min), then opens the report page. Log: `ares/tools/launch.log`.
